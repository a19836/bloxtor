...
class Differ {
   ...
   * $compareCharacters is true), and one of the constants Differ::UNMODIFIED (the
   * line or character is in both strings), Differ::DELETED (the line or character
   * is only in the first string), and Differ::INSERTED (the line or character is
