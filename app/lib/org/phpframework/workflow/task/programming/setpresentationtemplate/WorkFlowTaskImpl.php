<?php
namespace WorkFlowTask\programming\setpresentationtemplate;
...
class WorkFlowTaskImpl extends \WorkFlowTask {
	...
	public function createTaskPropertiesFromCodeStmt($stmt, $WorkFlowTaskCodeParser, &$exits = null, &$inner_tasks = null) {
		...
		if ($props) {
			...
			if ($method_name == "setTemplate" && empty($props["method_static"])) {
	...
	public function printCode($tasks, $stop_task_id, $prefix_tab = "", $options = null) {
		...
		$code  = $prefix_tab . $method_obj . "setTemplate(" . self::getVariableValueCode($properties["value"], $properties["type"]) . ");\n";
