...
class WorkFlowTaskImpl extends \WorkFlowTask {
	...
	public function printCode($tasks, $stop_task_id, $prefix_tab = "", $options = null) {
		...
		$code  = $prefix_tab . $method_obj . "addRegionBlock(" . self::getVariableValueCode($properties["region_id"], $properties["region_id_type"]) . ", " . self::getVariableValueCode($properties["block_id"], $properties["block_id_type"]) . ");\n";
