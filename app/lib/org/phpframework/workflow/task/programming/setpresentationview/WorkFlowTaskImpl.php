...
namespace WorkFlowTask\programming\setpresentationview;
...
class WorkFlowTaskImpl extends \WorkFlowTask {
	...
	public function createTaskPropertiesFromCodeStmt($stmt, $WorkFlowTaskCodeParser, &$exits = null, &$inner_tasks = null) {
		...
		if ($props) {
			...
			if ($method_name == "setView" && empty($props["method_static"])) {
				...
				$props["label"] = "Set " . self::prepareTaskPropertyValueLabelFromCodeStmt( basename($value) );
	...
	public function printCode($tasks, $stop_task_id, $prefix_tab = "", $options = null) {
		...
		$code  = $prefix_tab . $method_obj . "setView(" . self::getVariableValueCode(isset($properties["value"]) ? $properties["value"] : null, isset($properties["type"]) ? $properties["type"] : null) . ");\n";
