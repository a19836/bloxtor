...
class WorkFlowTaskImpl extends \WorkFlowTask {
	...
	public function printCode($tasks, $stop_task_id, $prefix_tab = "", $options = null) {
		...
		$code  = $prefix_tab . $method_obj . "resetRegionBlockJoinPoints(" . self::getVariableValueCode($region_id, $region_id_type) . ", " . self::getVariableValueCode($block_id, $block_id_type) . ");\n";
