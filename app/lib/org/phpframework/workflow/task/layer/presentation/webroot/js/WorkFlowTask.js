...
var PresentationLayerTaskPropertyObj = {
	allow_multi_lower_level_layer_connections : true, //false: only allow connections to Business-Logic layers
	...
	onLayerTaskCloning : function(task_id) {
		var WF = myWFObj.getTaskFlowChart();
		WF.TaskFlow.setTaskLabelByTaskId(task_id, {label: null});
