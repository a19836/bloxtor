...
class HashTagParameter {
	...
	const HTML_SUPER_GLOBAL_HASH_TAG_PARAMETER_FULL_REGEX = "/#(_GET|_POST|_REQUEST|_FILES|_COOKIE|_ENV|_SERVER|_SESSION|GLOBALS)(|\[" . self::HTML_TAG_PARAMETER_PARTIAL_REGEX . ")#/u";
