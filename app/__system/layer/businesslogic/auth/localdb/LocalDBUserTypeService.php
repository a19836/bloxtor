...
class LocalDBUserTypeService extends LocalDBAuthService {
	...
	public function changeTableEncryptionKey($data) {
		...
		return $this->LocalDBTableHandler->changeDBTableEncryptionKey("user_type", $data["new_encryption_key"]);
	}
	...
	public function dropAndCreateTable($data) {
		...
		return $this->LocalDBTableHandler->writeTableItems("", "user_type");
	}
	...
	public function insert($data) {
		...
		if (empty($data["user_type_id"]))
			$data["user_type_id"] = $this->LocalDBTableHandler->getPKMaxValue("user_type", "user_type_id") + 1;
		
		return $this->LocalDBTableHandler->insertItem("user_type", $data, array("user_type_id")) ? $data["user_type_id"] : null;
	}
	...
	public function update($data) {
		...
		return $this->LocalDBTableHandler->updateItem("user_type", $data, array("user_type_id"));
	}
	...
	public function delete($data) {
		...
		return $this->LocalDBTableHandler->deleteItem("user_type", array("user_type_id" => $data["user_type_id"]));
	}
	...
	public function get($data) {
		...
		$items = $this->LocalDBTableHandler->getItems("user_type");
		$new_items = $this->LocalDBTableHandler->filterItems($items, array("user_type_id" => $data["user_type_id"]), false, 1);
	...
	public function getAll($data) {
		...
		return $this->LocalDBTableHandler->getItems("user_type");
	}
