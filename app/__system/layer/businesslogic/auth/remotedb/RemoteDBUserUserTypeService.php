...
class RemoteDBUserUserTypeService extends CommonService {
	
	public function dropAndCreateTable($data) {
		$options = isset($data["options"]) ? $data["options"] : null;
		
		$table_data = array(
			"table_name" => "sysauth_user_user_type",
			"attributes" => array(
				array(
					"name" => "user_id",
					"type" => "bigint",
	...
	public function insert($data) {
		...
		return $this->getBroker()->callInsert("auth", "insert_user_user_type", $data, $options);
	}
	...
	public function delete($data) {
		...
		return $this->getBroker()->callDelete("auth", "delete_user_user_type", array("user_id" => $data["user_id"], "user_type_id" => $data["user_type_id"]), $options);
	}
	...
	public function deleteByConditions($data) {
		...
		return $this->getBroker()->callDelete("auth", "delete_user_user_types_by_conditions", array("conditions" => $cond), $options);
	}
	...
	public function get($data) {
		...
		$result = $this->getBroker()->callSelect("auth", "get_user_user_type", array("user_id" => $data["user_id"], "user_type_id" => $data["user_type_id"]), $options);
	...
	public function getAll($data) {
		...
		return $this->getBroker()->callSelect("auth", "get_all_user_user_types", null, $options);
	}
	...
	public function search($data) {
		...
		$cond = \DB::getSQLConditions($conditions, $conditions_join);
		return $cond ? $this->getBroker()->callSelect("auth", "get_user_user_types_by_conditions", array("conditions" => $cond), $options) : null;
	}
}
?>
