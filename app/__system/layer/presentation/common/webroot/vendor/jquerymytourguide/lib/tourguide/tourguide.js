        ...
        if (!this.container) {
          ...
          if (Array.isArray(this.actions) && this.actions.length > 0) {
            var actions = u$2("<div class=\"guided-tour-step-actions\">\n          ".concat(this.actions.map(function (action, index) {
              return "<".concat(action.href ? "a" : "button", " id=\"").concat(action.id, "\" ").concat(action.title ? "title=\"".concat(action.title, "\"") : "", " ").concat(action.href ? "href=\"".concat(action.href, "\"") : "", " ").concat(action.target ? "target=\"".concat(action.target, "\"") : "", " class=\"button").concat(action.primary ? " primary" : "").concat(action.class ? " ".concat(action.class) : "", "\" data-index=\"").concat(index, "\">").concat(action.label, "</").concat(action.href ? "a" : "button", ">");
            }).join(""), "\n        </div>"));
