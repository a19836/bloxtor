<!-- Used by the MyWidgetResourceLib -->
<!-- More cdn files in https://cdnjs.com/libraries/Chart.js => The latest is the https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.4.1/chart.umd.js -->
