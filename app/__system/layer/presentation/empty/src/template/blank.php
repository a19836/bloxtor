...
<html>
<head>
	<? if (!$EVC->getCMSLayer()->getCMSTemplateLayer()->getParam("are_main_head_tags_included_in_page_level")) { ?>
		<meta charset="utf-8">
	...
	<? if (!$EVC->getCMSLayer()->getCMSTemplateLayer()->getParam("is_bootstrap_lib_included_in_page_level")) { ?>
