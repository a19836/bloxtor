...
var LeaderLine = (function () {
    ...
    var Z,
        ...
        X = {
            ...
            diamond: { elmId: "leader-line-diamond", bBox: { left: -256, top: -256, width: 512, height: 512, right: 256, bottom: 256 }, widthR: 10, heightR: 10, bCircle: 20, sideLen: 20, backLen: 20, overhead: 20 },
        },
        F = { behind: Y, disc: "disc", square: "square", arrow1: "arrow1", arrow2: "arrow2", arrow3: "arrow3", hand: "hand", crosshair: "crosshair", diamond: "diamond" },
        q = { disc: "disc", square: "square", arrow1: "arrow1", arrow2: "arrow2", arrow3: "arrow3", hand: "hand", crosshair: "crosshair", diamond: "diamond" },
        G = [b, k, L, A],
        D = "auto",
        ...
        se = ie || S ? 0.2 : 0.1,
        ue = { path: T, lineColor: "coral", lineSize: 4, plugSE: [Y, "arrow1"], plugSizeSE: [1, 1], lineOutlineEnabled: !1, lineOutlineColor: "indianred", lineOutlineSize: 0.25, plugOutlineEnabledSE: [!1, !1], plugOutlineSizeSE: [1, 1] },
        he =
            ((p = {}.toString),
                ...
                stop: function (t, n) {
                    ...
                    return (
                        E.some(function (e) {
                            return (
                                e.animId === t &&
                                (n ? null != e.lastFrame && (a = e.frames[e.lastFrame].timeRatio) : ((a = (Date.now() - e.framesStart) / e.duration), (a = e.reverse ? 1 - a : a) < 0 ? (a = 0) : 1 < a && (a = 1)), !(e.framesStart = null))
                            );
                        }),
                        a
                    );
                        ...
                        return (
                            e.forEach(function (e) {
                                ...
                                "M" === e.type
                                    ...
                                    : "C" === e.type
                                    ? ((o = e.values[0]), (l = e.values[1]), (t = e.values[2]), (n = e.values[3]), (r = e.values[4]), (s = e.values[5]), u.push({ type: "C", values: [o, l, t, n, r, s] }), (p = t), (c = n), (d = r), (f = s))
                                    : "L" === e.type
                        ...
                        [0, 1].forEach(function (n) {
                            ...
                            Xe(m, _.plug_enabledSE, n, (S = g.plug_enabledSE[n]), v.apl_plug_enabledSE) && ((m.plugsFace.style[a.prop] = S ? "url(#" + m.plugMarkerIdSE[n] + ")" : "none"), (E = !0)),
                                g.plug_enabledSE[n] &&
                                    ...
                                    Xe(m, _.plug_colorSE, n, (S = g.plug_colorSE[n]), v.apl_plug_colorSE) && ((m.plugFaceSE[n].style.fill = S), (E = !0), (le || re || ie) && !g.line_colorTra && je(m, ie ? m.lineMaskCaps : m.capsMaskLine)),
    ...
    return (
        ...
        (ot.prototype.position = function () {
            return this.updated = $e(Se[this._id], { position: !0 }), this;
        }),
