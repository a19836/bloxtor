<?php
//GO TO http://<domain for this app>/__system/workflow/list_sample
//http://<domain for this app>/__system/phpframework/lib/jquerytaskflowchart/
...
<head>
	...
	<script language="javascript" type="text/javascript" src="<?= $common_link; ?>vendor/jquery/js/jquery.center.js"></script>
	
	<!-- Add Jquery UI JS and CSS files -->
	<link rel="stylesheet" href="<?= $common_link; ?>vendor/jqueryui/css/jquery-ui-1.11.4.css" type="text/css" />
	...
	<!--script type="text/javascript" src="<?= $common_link; ?>vendor/jqueryuitouchpunch/jquery.ui.touch-punch.min.js"></script-->
	...
	<style type="text/css">
		...
		/* Only if tasks_groups are active:
		...
		*/
		...
		.taskflowchart .tasks_flow > span.label {position:absolute; top:calc(50% - 20px); left:calc(50% - 115px); font-size:25px; color:#333; opacity:.5; white-space:nowrap;}
	</style>
	<script>
		;(function() {
			...
			/* 
			 * OTHER DEFAULT CONFIGURATIONS THAT YOU CAN CHAGE:
			...
			*/
			...
			/*
			 * INDIVIDUAL TASKS SETTINGS BASED IN TYPE:
			 */
...
<body>
	...
	<div id="taskflowchart" class="taskflowchart resizable_task_properties resizable_connection_properties">
		...
		<div id="workflow_menu" class="workflow_menu">
			...
			<ul class="dropdown">
				...
				<li class="" title="Other Examples">
					<a>Other Examples</a>
					<ul>
						<li class="logic_workflow" title="Logic Workflow">
							<a href="<?= $phpframework_link; ?>workflow/list_sample" target="logic_workflow">Logic Workflow</a>
						</li>
					</ul>
				</li>
			</ul>
		...
		<div class="tasks_flow scroll">
			<span class="label">Drop tasks here</span>
		</div>
		...
		<div class="connections_properties" style="display:none">
			...
			<div class="connection_properties connection_properties_tasktypea">
				...
				<div>
					<input class="connection_property_field" name="some_prop" placeHolder="write something here"/>
				</div>
				This is only an example without any styling...
			</div>
			...
			<div class="connection_properties connection_properties_tasktypeb">
				...
				<div>
					<textarea class="connection_property_field" name="some_other_prop" placeHolder="write something here"></textarea>
				</div>
				This is only an example without any styling...
			</div>
		</div>
