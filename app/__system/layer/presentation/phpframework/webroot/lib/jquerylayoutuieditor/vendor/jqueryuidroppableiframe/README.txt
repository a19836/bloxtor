...
https://gist.github.com/Craga89/8219459
	with fix: js/jquery-ui-droppable-iframe-fix-2.js

Note: It works too with jquery 1.8.1, this is:
	<!-- JQuery -->
	<script language="javascript" type="text/javascript" src="http://jplpinto.localhost/__system/common/vendor/jquery/js/jquery-1.8.1.min.js"></script>
	<script language="javascript" type="text/javascript" src="http://jplpinto.localhost/__system/common/vendor/jqueryui/js/jquery-ui-1.11.4.min.js"></script>
