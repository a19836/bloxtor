...
function LayoutUIEditorWidgetResource(ui_creator) {
	...
	function getSelectedWidgetListPropertiesSettingsHtml(widget) {
		...
		return '<li class="widget-property-shown-attrs-names" title="Choose the attributes to show">'
			 ...
			 + '</li>'
			 + '<li class="widget-property-check-callback with-extra-callbacks" title="Callback to check the fields before executing an action">'
	...
	function getSelectedWidgetFormPropertiesSettingsHtml(widget) {
		return '<li class="widget-property-shown-attrs-names" title="Choose the attributes to show">'
			 ...
			 + '	</ul>'
			 + '</li>'
			 + '<li class="widget-property-check-callback" title="Callback to check the fields before executing an action">'
			 + '	<label>On Check Callback: </label>'
			 + '	<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
			 + '	<input name="widget_properties[check]" placeHolder="Blank for default" />'
			 + '</li>'
			 + '<li class="widget-property-enter-key-press-callback" title="Callback when ENTER key is pressed">'
	...
	function getSelectedWidgetListCaptionPropertiesSettingsHtml(widget) {
		return '<li class="widget-property-draw-callback with-extra-callbacks" title="Callback to draw the list caption information">'
	...
	function getSelectedWidgetGraphPropertiesSettingsHtml(widget) {
		return '<li class="widget-group-info widget-property-graph-info">For more information or options about "Drawing a Graph" and how it works, please open the "<a href="https://www.chartjs.org/" target="chartjs">https://www.chartjs.org/</a>" web-page.</li>'
			 ...
			 + '<li class="group widget-property-graph-callbacks">'
				 ...
				 + '<ul>'
					 + '<li class="widget-property-graph-callbacks-parse with-extra-callbacks" title="Define a parse callback function for the chart main settings before the chart gets created">'
						 ...
						 + '<ul class="extra-callbacks"></ul>'
					 + '</li>'
					 + '<li class="widget-property-graph-callbacks-click with-extra-callbacks" title="Define a on-click callback function for the chart">'
						 ...
						 + '<ul class="extra-callbacks"></ul>'
					 + '</li>'
					 + '<li class="widget-property-graph-callbacks-hover with-extra-callbacks" title="Define a on-hover callback function for the chart">'
	...
	function getSelectedWidgetCalendarPropertiesSettingsHtml(widget) {
		return '<li class="widget-group-info widget-property-calendar-info">For more information or options about "Drawing a Calendar" and how it works, please open the "<a href="https://fullcalendar.io/" target="fullcalendar">https://fullcalendar.io/</a>" web-page.</div>'
			...
			+ '<li class="group widget-property-calendar-callbacks">'
				+ '<div class="group-title"><i class="zmdi zmdi-caret-down toggle" title="Toggle sub-Options"></i>Callbacks:</div>'
				+ '<ul>'
					+ '<li class="widget-property-calendar-callbacks-parse with-extra-callbacks" title="Define a parse callback function for the calendar main settings before the calendar gets created">'
						+ '<label>Parse Callback: </label>'
						+ '<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
					...
					+ '<li class="widget-property-calendar-callbacks-select with-extra-callbacks widget-swap-field select-shown" title="Define a on-select callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-click with-extra-callbacks widget-swap-field select-shown" title="Define a on-click callback function for the calendar events">'
						+ '<label>Click Callback: </label>'
						+ '<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-resize with-extra-callbacks widget-swap-field select-shown" title="Define a on-resize callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-move with-extra-callbacks widget-swap-field select-shown" title="Define a on-move callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-hover with-extra-callbacks widget-swap-field" title="Define a on-hover callback function for the calendar events">'
						+ '<label>Hover Callback: </label>'
						+ '<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-out with-extra-callbacks widget-swap-field" title="Define a on-out callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-add with-extra-callbacks widget-swap-field" title="Define a on-add callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-remove with-extra-callbacks widget-swap-field" title="Define a on-remove callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-mount with-extra-callbacks widget-swap-field" title="Define a on-mount callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-unmount with-extra-callbacks widget-swap-field select-shown" title="Define a on-unmount callback function for the calendar events">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-window-resize with-extra-callbacks widget-swap-field" title="Define a on-window-resize callback function for the calendar">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-calendar-show-loading with-extra-callbacks widget-swap-field" title="Define a on-show-loading callback function for the calendar">'
						...
						+ '<ul class="extra-callbacks"></ul>'
					+ '</li>'
					+ '<li class="widget-property-calendar-callbacks-calendar-hide-loading with-extra-callbacks widget-swap-field" title="Define a on-hide-loading callback function for the calendar">'
			...
			+ '<li class="group group-open widget-property-calendar-data-sets-settings">'
				...
				+ '<ul style="display:block;">'
					+ '<li class="widget-property-calendar-data-parse" title="Define a parse callback function for the data-set settings before it gets added to the calendar main settings">'
						+ '<label>Parse Callback: </label>'
						+ '<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
	...
	function getMainWidgetDisplayResourceValueSettingsHtml() {
		return '<li class="group widget-display-resource-value group-open with-display-disabled">'
			...
			+ '			<i class="zmdi zmdi-edit choose-widget-resource" title="Choose a Resource" onClick="' + ui_creator.obj_var_name + '.LayoutUIEditorWidgetResource.toggleChooseWidgetResourceReferencePopup(this, event)"></i>'
			 ...
			 + '			<ul class="extra-callbacks"></ul>'
			 + '		</li>'
			 + '		<li class="widget-display-resource-value-display-callback with-extra-callbacks" title="Callback on complete display or replace value">'
	...
	function getWidgetPropertiesCompleteCallbackHtml(type, funcs) {
		...
		return '<li class="widget-property-complete-callback widget-property-complete-callback-' + type + ' widget-swap-field with-extra-callbacks" title="Choose a callback to be called after all the \'' + label + '\' resources get executed.">'
	...
	function getWidgetResourcesEndCallbackHtml(type, funcs) {
		...
		return '<li class="widget-property-end-callback widget-property-end-callback-' + type + ' widget-swap-field with-extra-callbacks" title="Choose a callback to be called at the end of the ' + label + ' handler after the complete callback or if any resource is defined.">'
	...
	function getWidgetResourceSettingsHtml(prefix) {
		var html = '<li class="widget-resource">'
				 ...
				 + '		</li>'
				 + '		<li class="widget-resource-before-callback" title="Callback to parse the ajax settings before it sends the request">'
				 + '			<label>On Before Callback: </label>'
				 + '			<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
				 + '			<input name="' + prefix + '[idx][before]" />'
			 	 + '			<i class="zmdi zmdi-search choose-event" title="View and choose pre-defined handlers" onClick="' + ui_creator.obj_var_name + '.LayoutUIEditorWidgetResource.toggleChooseWidgetHandlerPopup(this, event)"></i>'
				 + '		</li>'
				 + '		<li class="widget-resource-parse-callback" title="Callback to parse the response">'
				 ...
				 + '			<input name="' + prefix + '[idx][parse]" />'
			 	 + '			<i class="zmdi zmdi-search choose-event" title="View and choose pre-defined handlers" onClick="' + ui_creator.obj_var_name + '.LayoutUIEditorWidgetResource.toggleChooseWidgetHandlerPopup(this, event)"></i>'
				 + '		</li>'
				 + '		<li class="widget-resource-validate-callback with-extra-callbacks" title="Callback to validate the response">'
				 ...
				 + '			<ul class="extra-callbacks"></ul>'
				 + '		</li>'
				 + '		<li class="widget-resource-success-callback with-extra-callbacks" title="Callback on success validation">'
				 ...
				 + '		</li>'
				 + '		<li class="widget-resource-error-callback with-extra-callbacks" title="Callback on error. If this callback returns false, the error message will not be displayed.">'
	...
	function getWidgetGraphDataSetSettingsHtml(prefix) {
		return '<li class="widget-property-graph-data-set">'
				...
				+ '<ul>'
					...
					+ '</li>'
					+ '<li class="widget-property-graph-data-set-data-parse" title="Define a parse callback function for this data settings before it gets added to the chart main settings">'
						+ '<label>Parse Callback: </label>'
						+ '<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
		...
		return '<li class="widget-property-calendar-data-set">'
				...
				+ '<ul>'
					...
					+ '<li class="widget-property-calendar-data-set-data-resource-name widget-swap-field select-shown">'
						...
						+ '<i class="zmdi zmdi-refresh refresh-existent-data" title="Refresh existent resources references in dropdown box" onClick="' + ui_creator.obj_var_name + '.LayoutUIEditorWidgetResource.refreshWidgetExistentResourcesReferences(this, event)"></i>'
					+ '</li>'
					+ '<li class="widget-property-calendar-data-set-data-parse" title="Define a parse callback function for this data settings before it gets added to the calendar main settings">'
						+ '<label>Parse Callback: </label>'
						+ '<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
						+ '<input name="' + prefix + '[idx][data_parse]" />'
					+ '</li>'
		...
		return '<li class="widget-property-calendar-resources-data-set">'
				...
				+ '<ul>'
					+ '<li class="widget-property-calendar-resources-data-set-data-resource-name widget-swap-field select-shown">'
						...
						+ '<i class="zmdi zmdi-refresh refresh-existent-data" title="Refresh existent resources references in dropdown box" onClick="' + ui_creator.obj_var_name + '.LayoutUIEditorWidgetResource.refreshWidgetExistentResourcesReferences(this, event)"></i>'
					+ '</li>'
					+ '<li class="widget-property-calendar-resources-data-set-data-parse" title="Define a parse callback function for this data settings before it gets added to the calendar main settings">'
						+ '<label>Parse Callback: </label>'
						+ '<i class="zmdi zmdi-close clear-user-input" title="Reset field"></i>'
						+ '<input name="' + prefix + '[idx][data_parse]" />'
					+ '</li>'
