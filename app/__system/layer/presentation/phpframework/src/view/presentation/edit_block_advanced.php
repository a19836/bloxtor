...
$WorkFlowUIHandler->setTasksGroupsByTag(array(
	...
	"Layers" => array("callbusinesslogic", "callpresentationlayerwebservice", "setpresentationview", "addpresentationview", "setpresentationtemplate", "getblockidfromfilepath", "createblockhtml", "createblock"),
...
$save_url = $project_url_prefix . 'phpframework/presentation/save_block_advanced?bean_name=' . $bean_name . '&bean_file_name=' . $bean_file_name . '&path=' . $path;
...
<link rel="stylesheet" href="' . $project_url_prefix . 'css/presentation/edit_block_advanced.css" type="text/css" charset="utf-8" />
...
GetBlockIdFromFilePathTaskPropertyObj.brokers_options = ' . json_encode(array("default" => '$EVC->getCMSLayer()->getCMSBlockLayer()')) . ';
CreateBlockHtmlTaskPropertyObj.brokers_options = ' . json_encode(array("default" => '$EVC->getCMSLayer()->getCMSBlockLayer()')) . ';
CreateBlockTaskPropertyObj.brokers_options = ' . json_encode(array("default" => '$EVC->getCMSLayer()->getCMSBlockLayer()')) . ';
...
if (!empty($obj_data)) {
	...
	//prepare block html
	$main_content .= '
	<div class="block_obj with_top_bar_tab' . ($popup ? " in_popup" : "") . '">
