...
for ($i = 0; $i < $t; $i++) {
	...
	$main_content .= '<tr>
		<td class="object_type_id">' . (isset($object_type["object_type_id"]) ? $object_type["object_type_id"] : "") . '</td>
		<td class="name">' . (isset($object_type["name"]) ? $object_type["name"] : "") . '</td>
		<td class="created_date">' . (isset($object_type["created_date"]) ? $object_type["created_date"] : "") . '</td>
		<td class="modified_date">' . (isset($object_type["modified_date"]) ? $object_type["modified_date"] : "") . '</td>
		<td class="buttons">
			<a class="icon edit" href="' . $project_url_prefix . 'user/edit_object_type?object_type_id=' . (isset($object_type["object_type_id"]) ? $object_type["object_type_id"] : "") . '" title="Edit">Edit</a>
		</td>
	</tr>';
}
