					...
					2 => array(
						"field" => array(
							...
							"input" => array(
								...
								"place_holder" => "Fill the current table key",
								"extra_attributes" => array(
									0 => array(
										"name" => "allowNull",
										"value" => "false"
...
if ($is_local_db) {
	...
	$main_content .= '<div class="info">Clicking the "Save" button enables the system to validate the keys, ensuring they are correct and currently in use. If validated, the system will update the new keys in the User Authentication Database. This action should only be performed for security purposes.</div>';
}
else {
