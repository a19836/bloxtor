				...
				"elements" => array(
					0 => array(
						"field" => array(
							...
							"input" => array(
								"type" => "hidden",
								"name" => "user_type_data[user_type_id]",
								"value" => "#user_type_id#",
							)
						)
					),
		...
		1 => array(
			"container" => array(
				...
				"elements" => array(
					...
					1 => array(
						"field" => array(
							"class" => "submit_button" . ($user_type_id ? "" : " hidden"),
							"input" => array(
								"type" => "submit",
								"name" => "delete",
								"value" => "Delete",
								...
								"extra_attributes" => array(
									...
									1 => array(
										...
										"value" => "Do you wish to remove this user type?"
									)
								),
							)
						)
...
<div id="content">
	<div class="edit_user_type">
		<div class="top_bar">
			<header>
				<div class="title">' . ($user_type_id ? 'Edit' : 'Add') . ' User Type</div>
				<ul>
...
$main_content .= HtmlFormHandler::createHtmlForm($form_settings, $user_type_data);
$main_content .= '</div>
</div>';
?>
