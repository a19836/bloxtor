...
$tree_layout = $_GET["tree_layout"];
$advanced_level = $_GET["advanced_level"];
...
if (array_key_exists("advanced_level", $_GET)) {
...
if (array_key_exists("tree_layout", $_GET)) {
...
if (array_key_exists("theme_layout", $_GET)) {
...
if (array_key_exists("main_navigator_side", $_GET)) {
...
if (array_key_exists("filter_by_layout", $_GET))
